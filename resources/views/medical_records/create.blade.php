...
<div class="p-6 space-y-6">
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border max-w-3xl">
        ...
        <form id="medicalForm" method="POST" action="{{ route('medical-records.store', $patient->id) }}" class="space-y-6" enctype="multipart/form-data">
            @csrf

            @include('medical_records._form', ['record' => null])
